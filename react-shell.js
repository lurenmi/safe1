  ...
  function AppShell(){
    return h(React.Fragment,null,
      ...
      h('header',{className:'topbar'},
        h('div',{className:'brand'},h('span',{className:'shield brand-emblem'},h('i',{className:'ti ti-shield-radar','aria-hidden':'true'})),h('div',null,h('strong',null,'重大活动低空安防平台'),h('small',null,'MAJOR EVENT LOW-ALTITUDE SECURITY'))),
      ...
      h('aside',{className:'sidebar'},h('button',{className:'sidebar-toggle','aria-label':'折叠导航',title:'收起导航'},h('i',{className:'ti ti-layout-sidebar-left-collapse','aria-hidden':'true'})),h('nav',{id:'sideNav'}),h('div',{className:'city'})),
