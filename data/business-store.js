(function(){
  ...
  const seed={activities:[
    ...
    {id:'ACT-20261018',name:'杭州奥体中心大型演唱会安保任务',place:'杭州奥体中心体育场（大莲花）',start:'2026-10-18T16:00',end:'2026-10-18T23:30',status:'已配置',center:[120.224459,30.231610],levels:[{name:'核心禁飞区',radius:500,color:'#ef4d4d',height:120},{name:'重点管控区',radius:1500,color:'#f39a32',height:200},{name:'外围预警区',radius:3000,color:'#6576f5',height:300}],polygon:null,updatedAt:'2026-10-15 14:20'},
